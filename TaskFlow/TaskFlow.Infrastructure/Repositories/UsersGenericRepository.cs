...
{
    public class UsersGenericRepository<TEntity> : IUsersGenericRepository<TEntity> 
        where TEntity : class
    {
        private DbSet<TEntity>? _dbSet;
        private readonly ILogger<UsersGenericRepository<TEntity>> _logger;

        public UsersGenericRepository(UsersDBContext context, ILogger<UsersGenericRepository<TEntity>> logger)
        {
